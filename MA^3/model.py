...
base_model_2 = generate_MLSTM_model()

train_model(base_model_2, DATASET_INDEX, dataset_prefix='MLSTM', epochs=40, batch_size=128, normalize_timeseries=True, monitor="val_accuracy", optimization_mode="max")

base_model_2.save_weights('./weights/generate_MLSTM1_model.h5')

evaluate_model(base_model_2, DATASET_INDEX, dataset_prefix='MLSTM', batch_size=128, normalize_timeseries=True)
